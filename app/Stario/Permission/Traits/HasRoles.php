...
use Star\Permission\Contracts\Permission;
use Star\Permission\Contracts\Role;
...
trait HasRoles
{
    ...
    {
        return $this->belongsToMany(\Star\Permission\Models\Permission::class);
    }
     ...
     *
     * @param array|string|\Star\Permission\Models\Role ...$roles
     *
     * @return \Star\Permission\Contracts\Role
     */
